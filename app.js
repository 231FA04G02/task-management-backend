...
const { sendInstantEmail } = require("./emailReminder");
...
app.post("/user/:id", async (req, res) => {
  ...
  try {
    ...
    await sendInstantEmail(user, taskName);

    res.status(200).json({ message: "Task added and email sent successfully", user });
  } catch (err) {
